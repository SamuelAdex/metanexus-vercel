  ...
  return (
    <section className='relative md:mt-[-12rem] mt-[6rem] whitelist'>
        ...
        <div className='2xl:w-[742px] absolute md:w-[660px] space-y-5 md:top-[80px] top-[30px] md:px-14 px-10'>
            ...
            <p className='text-white drop-shadow-xl 2xl:text-[25px] md:text-[20px] poppins text-[15px]'>Explore Metanexus world today and unlock a world of endless opportunities!</p>
